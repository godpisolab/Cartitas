...
- **Reintentos con backoff exponencial + jitter** (`request_with_retries`) en cada petición HTTP: reintenta en errores de red, 429 y 5xx; no reintenta en 404 u otros 4xx (no cambiaría el resultado).
