...
class TestRobotsCheckTarget:
    def test_shopify(self):
        ...
        assert base_script._robots_check_target(cfg) == "https://t.example/collections/one-piece"
    ...
    def test_prestashop(self):
        ...
        assert base_script._robots_check_target(cfg) == "https://t.example/10-categoria"
    ...
    def test_woocommerce_con_fallback_paths(self):
        ...
        assert base_script._robots_check_target(cfg) == "https://t.example/product-category/op/"
    ...
    def test_woocommerce_sin_fallback_paths_devuelve_none(self):
        ...
        assert base_script._robots_check_target(cfg) is None

    def test_odoo(self):
        cfg = StoreConfig("T", "https://t.example", Platform.ODOO,
                           odoo_category_url="https://t.example/shop/category/op-10")
        assert base_script._robots_check_target(cfg) == "https://t.example/shop/category/op-10"
    ...
    def test_opencart(self):
        ...
        assert base_script._robots_check_target(cfg) == "https://t.example/index.php?route=product/category&path=1"
    ...
    def test_generic_jsonld(self):
        ...
        assert base_script._robots_check_target(cfg) == "https://t.example/categoria"
